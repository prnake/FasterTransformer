...
{
    invokeAddBiasGelu<T>(inter_buf_[0], glu_ffn_weights->intermediate_weight[0].bias, m, inter_size_, stream_);
    invokeAddBias<T>(inter_buf_[1], glu_ffn_weights->intermediate_weight[1].bias, m, inter_size_, stream_);
...
{
    invokeAddBiasRelu<T>(inter_buf_[0], glu_ffn_weights->intermediate_weight[0].bias, m, inter_size_, stream_);
    invokeAddBias<T>(inter_buf_[1], glu_ffn_weights->intermediate_weight[1].bias, m, inter_size_, stream_);
    invokeDot<T>(inter_buf_[0], inter_buf_[1], m, inter_size_, stream_);
}
